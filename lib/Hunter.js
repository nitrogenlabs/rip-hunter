Object.defineProperty(exports,'__esModule',{value:!0});var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||!1,descriptor.configurable=!0,'value'in descriptor&&(descriptor.writable=!0),Object.defineProperty(target,descriptor.key,descriptor)}}return function(Constructor,protoProps,staticProps){return protoProps&&defineProperties(Constructor.prototype,protoProps),staticProps&&defineProperties(Constructor,staticProps),Constructor}}();var _events=require('events'),_events2=_interopRequireDefault(_events),_immutable=require('immutable'),_immutable2=_interopRequireDefault(_immutable),_lodash=require('lodash'),_lodash2=_interopRequireDefault(_lodash),_APIError=require('./errors/APIError'),_APIError2=_interopRequireDefault(_APIError);
...
if(_lodash2.default.isObject(a)){var _ret=function(){
...
c.join(', ')+'}'})}();if('object'==typeof _ret)return _ret.v;
...
a,b){var _this3=this,c=2<arguments.length&&void 0!==arguments[2]?arguments[2]:'',d=arguments[3];
...
return a=a?a.trim():'',c=c||'',d=d?{}:{'Content-Type':'application/graphql','Cache-Control':'no-cache'},''!==c&&(d.Authorization='Bearer '+c),console.log('_getGraph::headers',d),console.log('_getGraph::body',b),fetch(a,{
method:'post',
headers:d,
body:b}).
...
g=e.headers.getAll('Content-Type').some(function(h){return f.test(h)});return(

console.log('_getGraph::response',JSON.stringify(e)),
g?
e.json():
...
if(console.log('_getGraph::json',e),!e||e.errors){
if(!e)
...
throw e.source||(e=new _APIError2.default(_immutable2.default.fromJS([{message:'network_error'}]),e)),_this3.emit('rip_hunter_error',e),e;
});
