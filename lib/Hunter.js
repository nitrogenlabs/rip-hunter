...
then(function(g){
var h=/application\/json/i;return(
f=g.headers.getAll('Content-Type').some(function(i){return h.test(i)}),
...
then(function(g){return(
f?
_immutable2.default.fromJS(g):
